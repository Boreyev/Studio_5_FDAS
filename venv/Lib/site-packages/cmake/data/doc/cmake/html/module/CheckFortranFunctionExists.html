...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CheckFortranFunctionExists &mdash; CMake 3.22.4 Documentation</title>
...
<p>This command does not detect functions in Fortran modules. In general it is
recommended to use <span class="target" id="index-0-module:CheckSourceCompiles"></span><a class="reference internal" href="CheckSourceCompiles.html#module:CheckSourceCompiles" title="CheckSourceCompiles"><code class="xref cmake cmake-module docutils literal notranslate"><span class="pre">CheckSourceCompiles</span></code></a> instead to determine if a
Fortran function or subroutine is available.</p>
</div>
