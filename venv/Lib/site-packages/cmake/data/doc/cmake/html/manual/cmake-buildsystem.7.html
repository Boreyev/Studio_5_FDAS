...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>cmake-buildsystem(7) &mdash; CMake 3.22.4 Documentation</title>
  ...
  <li>
    <a href="../index.html">3.22.4 Documentation</a> &#187;
  </li>
...
<h1><a class="toc-backref" href="#id14">cmake-buildsystem(7)</a><a class="headerlink" href="#cmake-buildsystem-7" title="Permalink to this headline">¶</a></h1>
<div class="contents topic" id="contents">
<p class="topic-title">Contents</p>
<ul class="simple">
<li><p><a class="reference internal" href="#cmake-buildsystem-7" id="id14">cmake-buildsystem(7)</a></p>
<ul>
<li><p><a class="reference internal" href="#introduction" id="id15">Introduction</a></p></li>
<li><p><a class="reference internal" href="#binary-targets" id="id16">Binary Targets</a></p>
<ul>
<li><p><a class="reference internal" href="#binary-executables" id="id17">Binary Executables</a></p></li>
<li><p><a class="reference internal" href="#binary-library-types" id="id18">Binary Library Types</a></p>
<ul>
<li><p><a class="reference internal" href="#normal-libraries" id="id19">Normal Libraries</a></p>
<ul>
<li><p><a class="reference internal" href="#apple-frameworks" id="id20">Apple Frameworks</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#object-libraries" id="id21">Object Libraries</a></p></li>
</ul>
</li>
</ul>
</li>
<li><p><a class="reference internal" href="#build-specification-and-usage-requirements" id="id22">Build Specification and Usage Requirements</a></p>
<ul>
<li><p><a class="reference internal" href="#target-properties" id="id23">Target Properties</a></p></li>
<li><p><a class="reference internal" href="#transitive-usage-requirements" id="id24">Transitive Usage Requirements</a></p></li>
<li><p><a class="reference internal" href="#compatible-interface-properties" id="id25">Compatible Interface Properties</a></p></li>
<li><p><a class="reference internal" href="#property-origin-debugging" id="id26">Property Origin Debugging</a></p></li>
<li><p><a class="reference internal" href="#build-specification-with-generator-expressions" id="id27">Build Specification with Generator Expressions</a></p>
<ul>
<li><p><a class="reference internal" href="#include-directories-and-usage-requirements" id="id28">Include Directories and Usage Requirements</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#link-libraries-and-generator-expressions" id="id29">Link Libraries and Generator Expressions</a></p></li>
<li><p><a class="reference internal" href="#output-artifacts" id="id30">Output Artifacts</a></p>
<ul>
<li><p><a class="reference internal" href="#runtime-output-artifacts" id="id31">Runtime Output Artifacts</a></p></li>
<li><p><a class="reference internal" href="#library-output-artifacts" id="id32">Library Output Artifacts</a></p></li>
<li><p><a class="reference internal" href="#archive-output-artifacts" id="id33">Archive Output Artifacts</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#directory-scoped-commands" id="id34">Directory-Scoped Commands</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#build-configurations" id="id35">Build Configurations</a></p>
<ul>
<li><p><a class="reference internal" href="#case-sensitivity" id="id36">Case Sensitivity</a></p></li>
<li><p><a class="reference internal" href="#default-and-custom-configurations" id="id37">Default And Custom Configurations</a></p></li>
</ul>
</li>
<li><p><a class="reference internal" href="#pseudo-targets" id="id38">Pseudo Targets</a></p>
<ul>
<li><p><a class="reference internal" href="#imported-targets" id="id39">Imported Targets</a></p></li>
<li><p><a class="reference internal" href="#alias-targets" id="id40">Alias Targets</a></p></li>
<li><p><a class="reference internal" href="#interface-libraries" id="id41">Interface Libraries</a></p></li>
</ul>
</li>
</ul>
</li>
...
<h2><a class="toc-backref" href="#id16">Binary Targets</a><a class="headerlink" href="#binary-targets" title="Permalink to this headline">¶</a></h2>
...
<h3><a class="toc-backref" href="#id17">Binary Executables</a><a class="headerlink" href="#binary-executables" title="Permalink to this headline">¶</a></h3>
...
<h3><a class="toc-backref" href="#id18">Binary Library Types</a><a class="headerlink" href="#binary-library-types" title="Permalink to this headline">¶</a></h3>
<div class="section" id="normal-libraries">
<span id="id1"></span><h4><a class="toc-backref" href="#id19">Normal Libraries</a><a class="headerlink" href="#normal-libraries" title="Permalink to this headline">¶</a></h4>
...
<span id="id2"></span><h5><a class="toc-backref" href="#id20">Apple Frameworks</a><a class="headerlink" href="#apple-frameworks" title="Permalink to this headline">¶</a></h5>
...
<span id="id3"></span><h4><a class="toc-backref" href="#id21">Object Libraries</a><a class="headerlink" href="#object-libraries" title="Permalink to this headline">¶</a></h4>
...
<h2><a class="toc-backref" href="#id22">Build Specification and Usage Requirements</a><a class="headerlink" href="#build-specification-and-usage-requirements" title="Permalink to this headline">¶</a></h2>
...
<h3><a class="toc-backref" href="#id23">Target Properties</a><a class="headerlink" href="#target-properties" title="Permalink to this headline">¶</a></h3>
...
<span id="target-usage-requirements"></span><h3><a class="toc-backref" href="#id24">Transitive Usage Requirements</a><a class="headerlink" href="#transitive-usage-requirements" title="Permalink to this headline">¶</a></h3>
...
<span id="id4"></span><h3><a class="toc-backref" href="#id25">Compatible Interface Properties</a><a class="headerlink" href="#compatible-interface-properties" title="Permalink to this headline">¶</a></h3>
...
<h3><a class="toc-backref" href="#id26">Property Origin Debugging</a><a class="headerlink" href="#property-origin-debugging" title="Permalink to this headline">¶</a></h3>
...
<h3><a class="toc-backref" href="#id27">Build Specification with Generator Expressions</a><a class="headerlink" href="#build-specification-with-generator-expressions" title="Permalink to this headline">¶</a></h3>
...
<span id="id5"></span><h4><a class="toc-backref" href="#id28">Include Directories and Usage Requirements</a><a class="headerlink" href="#include-directories-and-usage-requirements" title="Permalink to this headline">¶</a></h4>
...
<h3><a class="toc-backref" href="#id29">Link Libraries and Generator Expressions</a><a class="headerlink" href="#link-libraries-and-generator-expressions" title="Permalink to this headline">¶</a></h3>
...
<span id="id6"></span><h3><a class="toc-backref" href="#id30">Output Artifacts</a><a class="headerlink" href="#output-artifacts" title="Permalink to this headline">¶</a></h3>
...
<span id="id7"></span><h4><a class="toc-backref" href="#id31">Runtime Output Artifacts</a><a class="headerlink" href="#runtime-output-artifacts" title="Permalink to this headline">¶</a></h4>
...
<span id="id8"></span><h4><a class="toc-backref" href="#id32">Library Output Artifacts</a><a class="headerlink" href="#library-output-artifacts" title="Permalink to this headline">¶</a></h4>
...
<span id="id9"></span><h4><a class="toc-backref" href="#id33">Archive Output Artifacts</a><a class="headerlink" href="#archive-output-artifacts" title="Permalink to this headline">¶</a></h4>
...
<h3><a class="toc-backref" href="#id34">Directory-Scoped Commands</a><a class="headerlink" href="#directory-scoped-commands" title="Permalink to this headline">¶</a></h3>
...
<span id="id10"></span><h2><a class="toc-backref" href="#id35">Build Configurations</a><a class="headerlink" href="#build-configurations" title="Permalink to this headline">¶</a></h2>
...
<span class="nf">string(</span><span class="no">TOLOWER</span><span class="w"> </span><span class="o">${</span><span class="nt">CMAKE_BUILD_TYPE</span><span class="o">}</span><span class="w"> </span><span class="nb">build_type</span><span class="nf">)</span><span class="w"></span>
<span class="nf">if</span> <span class="nf">(</span><span class="nb">build_type</span><span class="w"> </span><span class="no">STREQUAL</span><span class="w"> </span><span class="nb">debug</span><span class="nf">)</span><span class="w"></span>
...
accounted for by the above <code class="docutils literal notranslate"><span class="pre">$&lt;CONFIG:Debug&gt;</span></code> expression.</p>
<div class="section" id="case-sensitivity">
<h3><a class="toc-backref" href="#id36">Case Sensitivity</a><a class="headerlink" href="#case-sensitivity" title="Permalink to this headline">¶</a></h3>
...
values will be case-sensitive.  The <code class="docutils literal notranslate"><span class="pre">$&lt;CONFIG&gt;</span></code> generator expression also
...
<span class="nf">set(</span><span class="no">CMAKE_BUILD_TYPE</span><span class="w"> </span><span class="nb">Debug</span><span class="nf">)</span><span class="w"></span>
<span class="nf">if(</span><span class="no">CMAKE_BUILD_TYPE</span><span class="w"> </span><span class="no">STREQUAL</span><span class="w"> </span><span class="no">DEBUG</span><span class="nf">)</span><span class="w"></span>
<span class="w">  </span><span class="c"># ... will never get here, &quot;Debug&quot; != &quot;DEBUG&quot;</span>
<span class="nf">endif()</span><span class="w"></span>
<span class="nf">add_custom_target(</span><span class="nb">print_config</span><span class="w"> </span><span class="no">ALL</span><span class="w"></span>
<span class="w">  </span><span class="c"># Prints &quot;Config is Debug&quot; in this single-config case</span>
<span class="w">  </span><span class="no">COMMAND</span><span class="w"> </span><span class="o">${</span><span class="nt">CMAKE_COMMAND</span><span class="o">}</span><span class="w"> </span><span class="p">-</span><span class="no">E</span><span class="w"> </span><span class="nb">echo</span><span class="w"> </span><span class="s">&quot;Config is $&lt;CONFIG&gt;&quot;</span><span class="w"></span>
<span class="w">  </span><span class="no">VERBATIM</span><span class="w"></span>
<span class="nf">)</span><span class="w"></span>

<span class="nf">set(</span><span class="no">CMAKE_CONFIGURATION_TYPES</span><span class="w"> </span><span class="nb">Debug</span><span class="w"> </span><span class="nb">Release</span><span class="nf">)</span><span class="w"></span>
<span class="nf">if(</span><span class="no">DEBUG</span><span class="w"> </span><span class="no">IN_LIST</span><span class="w"> </span><span class="no">CMAKE_CONFIGURATION_TYPES</span><span class="nf">)</span><span class="w"></span>
<span class="w">  </span><span class="c"># ... will never get here, &quot;Debug&quot; != &quot;DEBUG&quot;</span>
<span class="nf">endif()</span><span class="w"></span>
</pre></div>
</div>
...
For example, the <code class="docutils literal notranslate"><span class="pre">$&lt;CONFIG:Debug&gt;</span></code> generator expression will evaluate to 1
...
<div class="section" id="default-and-custom-configurations">
<h3><a class="toc-backref" href="#id37">Default And Custom Configurations</a><a class="headerlink" href="#default-and-custom-configurations" title="Permalink to this headline">¶</a></h3>
...
<h2><a class="toc-backref" href="#id38">Pseudo Targets</a><a class="headerlink" href="#pseudo-targets" title="Permalink to this headline">¶</a></h2>
...
<span id="id11"></span><h3><a class="toc-backref" href="#id39">Imported Targets</a><a class="headerlink" href="#imported-targets" title="Permalink to this headline">¶</a></h3>
...
<span id="id12"></span><h3><a class="toc-backref" href="#id40">Alias Targets</a><a class="headerlink" href="#alias-targets" title="Permalink to this headline">¶</a></h3>
...
<span id="id13"></span><h3><a class="toc-backref" href="#id41">Interface Libraries</a><a class="headerlink" href="#interface-libraries" title="Permalink to this headline">¶</a></h3>
