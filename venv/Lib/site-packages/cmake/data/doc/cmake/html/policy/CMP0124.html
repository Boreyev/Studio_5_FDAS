...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMP0124 &mdash; CMake 3.22.4 Documentation</title>
...
<p>When this policy is set to <code class="docutils literal notranslate"><span class="pre">NEW</span></code>, the scope of loop variables defined by the
<span class="target" id="index-0-command:foreach"></span><a class="reference internal" href="../command/foreach.html#command:foreach" title="foreach"><code class="xref cmake cmake-command docutils literal notranslate"><span class="pre">foreach()</span></code></a> command is restricted to the loop only.  They will be unset
at the end of the loop.</p>
<p>The <code class="docutils literal notranslate"><span class="pre">OLD</span></code> behavior for this policy still clears the loop variables at the end
of the loop, but does not unset them.  This leaves them as defined, but empty.</p>
