...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>add_custom_command &mdash; CMake 3.22.4 Documentation</title>
...
<p>Specify a <code class="docutils literal notranslate"><span class="pre">.d</span></code> depfile which holds dependencies for the custom command.
It is usually emitted by the custom command itself.  This keyword may only
be used if the generator supports it, as detailed below.</p>
<div class="versionadded">
