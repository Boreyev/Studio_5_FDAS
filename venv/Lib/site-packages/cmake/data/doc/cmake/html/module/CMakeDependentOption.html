...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  <head>
    <meta charset="utf-8" />
  <title>CMakeDependentOption &mdash; CMake 3.22.4 Documentation</title>
...
<dl class="command">
<dt id="command:cmake_dependent_option">
<code class="sig-name descname">cmake_dependent_option</code><a class="headerlink" href="#command:cmake_dependent_option" title="Permalink to this definition">¶</a></dt>
...
<p>Makes <code class="docutils literal notranslate"><span class="pre">&lt;option&gt;</span></code> available to the user if <code class="docutils literal notranslate"><span class="pre">&lt;depends&gt;</span></code> is true. When
...
the user is preserved for when the option is presented again. In case <code class="docutils literal notranslate"><span class="pre">&lt;depends&gt;</span></code>
is a <a class="reference internal" href="../manual/cmake-language.7.html#cmake-language-lists"><span class="std std-ref">semicolon-separated list</span></a>, all elements must
be true in order to initialize <code class="docutils literal notranslate"><span class="pre">&lt;option&gt;</span></code> with <code class="docutils literal notranslate"><span class="pre">&lt;value&gt;</span></code>.</p>
</dd></dl>
