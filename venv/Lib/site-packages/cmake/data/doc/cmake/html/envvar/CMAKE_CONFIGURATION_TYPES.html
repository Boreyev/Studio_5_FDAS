...
<span id="envvar:CMAKE_CONFIGURATION_TYPES"></span><h1>CMAKE_CONFIGURATION_TYPES<a class="headerlink" href="#cmake-configuration-types" title="Permalink to this headline">¶</a></h1>
...
<p>The <code class="docutils literal notranslate"><span class="pre">CMAKE_CONFIGURATION_TYPES</span></code> environment variable specifies a
default value for the <span class="target" id="index-0-variable:CMAKE_CONFIGURATION_TYPES"></span><a class="reference internal" href="../variable/CMAKE_CONFIGURATION_TYPES.html#variable:CMAKE_CONFIGURATION_TYPES" title="CMAKE_CONFIGURATION_TYPES"><code class="xref cmake cmake-variable docutils literal notranslate"><span class="pre">CMAKE_CONFIGURATION_TYPES</span></code></a> variable
when there is no explicit configuration given on the first run while
creating a new build tree.</p>
</div>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../_sources/envvar/CMAKE_CONFIGURATION_TYPES.rst.txt"
